...
public class ItemInit {
	...
	public static final RegistryObject<Item> RIFT_ARCHITECT = register("rift_architect", () -> new BowItem(new Item.Properties().tab(MultiverseCraft.MULTIVERSE_TAB).stacksTo(1)));
